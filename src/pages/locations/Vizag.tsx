...
const Vizag = () => (
  <LocationPage
    ...
    description="Trusted invisible grills installation services in Visakhapatnam (Vizag). Serving residential and commercial properties across the city with premium quality products."
    areas={[

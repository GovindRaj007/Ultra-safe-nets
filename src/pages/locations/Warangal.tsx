...
const Warangal = () => (
  <LocationPage
    ...
    description="Professional invisible grills installation in Warangal. Expert team providing comprehensive safety solutions for homes and businesses throughout the city."
    areas={[

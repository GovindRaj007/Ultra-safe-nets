            ...
            <ul className="space-y-4">
              <li>
                <a 
                  ...
                  className="flex items-start gap-3 text-muted-foreground hover:text-primary-foreground transition-colors"
                >
              ...
              <li>
                <a href="mailto:urbaninvisiblegrills.ap@gmail.com" className="flex items-start gap-3 text-muted-foreground hover:text-primary-foreground transition-colors">
